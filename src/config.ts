...
export const THEATERS: Theater[] = [
  ...
  },
  {
    ...
    lat: 22.3193,
    heading: 0.7,
    briefing: "빅토리아 하버 상공. 해협을 봉쇄 중인 적기를 격퇴하라.",
    enemyName: "남중국해 편대",
  },
  {
    id: "singapore",
  ...
  },
  {
    ...
    lat: 41.0082,
    heading: 0.6,
    briefing: "유럽과 아시아를 가르는 해협 상공. 양안 제공권을 사수하라.",
    enemyName: "보스포루스 편대",
  },
  {
    id: "paris",
  ...
  },
  {
    ...
    lat: -33.9249,
    heading: 0.4,
    briefing: "희망봉 상공. 남대서양으로 빠져나가는 적 주력을 요격하라.",
    enemyName: "희망봉 편대",
  },
  {
    id: "moscow",
    ...
    lat: 55.7558,
    heading: 0.8,
    briefing: "북위 고공. 수도 외곽에서 적 에이스 편대와 교전하라.",
    enemyName: "북방 에이스",
  },
  {
    id: "sydney",
